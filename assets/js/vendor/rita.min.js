!function(window, undefined) {
    function makeClass() {
        return function(e) {
            return this instanceof arguments.callee ? void ("function" == typeof this.init && this.init.apply(this, e && e.callee ? e : arguments)) : new arguments.callee(arguments)
        }
    }
    function printProgress(e, t, i) {
        process && process.stdout && (process.stdout.clearLine(),
        process.stdout.cursorTo(0),
        process.stdout.write(e + t + "%" + (i ? "\n" : "")))
    }
    function is(e, t) {
        return get(e) === t
    }
    function ok(e, t) {
        if (get(e) != t)
            throw TypeError("Expected " + (t ? t.toUpperCase() : t + E) + ", but received " + (e ? get(e).toUpperCase() : e + E));
        return !0
    }
    function isNum(e) {
    ...
    function err() {
        for (var e = "[RiTa] " + arguments[0], t = 1; t < arguments.length; t++)
            e += "\n" + arguments[t];
        throw Error(e)
    }
    function warn() {
        if (!RiTa.SILENT && console && arguments && arguments.length) {
            console.warn("[WARN] " + arguments[0]);
            for (var e = 1; e < arguments.length; e++)
                console.warn(arguments[e])
        }
    }
    function log() {
        !RiTa.SILENT && console && console.log.apply(console, arguments)
    }
    function strOk(e) {
        return typeof e === S && e.length > 0
    }
    function trim(e) {
        return strOk(e) ? e.replace(/^\s\s*/, "").replace(/\s\s*$/, "") : e
    }
    function last(e) {
        return e && e.length ? e.charAt(e.length - 1) : E
    }
    function extend(e, t) {
    ...
    function endsWith(e, t) {
        return !!is(e, S) && new RegExp(t + "$").test(e)
    }
    function startsWith(e, t) {
        return !!is(e, S) && new RegExp("^" + t).test(e)
    }
    function equalsIgnoreCase(e, t) {
        return !(!is(e, S) || !is(t, S)) && e.toLowerCase() === t.toLowerCase()
    }
    function isNode() {
    ...
    function tagForPENN(e) {
        if (!e || !e.length)
            return EA;
        var t = is(e, S) ? RiTa.tokenize(e) : e;
        return PosTagger.tag(t)
    }
    function tagForWordNet(e) {
        var t, i = tagForPENN(e);
        if (e && i.length) {
            for (var n = 0; n < i.length; n++)
                t = i[n],
                i[n] = "-",
                PosTagger.isNoun(t) ? i[n] = "n" : PosTagger.isVerb(t) ? i[n] = "v" : PosTagger.isAdverb(t) ? i[n] = "r" : PosTagger.isAdj(t) && (i[n] = "a");
            return i
        }
        return EA
    }
    function initFeatureMap(e) {
        e._features ? ["tokens", "stresses", "phonemes", "syllables", "pos"].forEach(function(t) {
            delete e._features[t]
        }) : e._features = {},
        e._features.text = e.text()
    }
    function checkPluralNoLex(e) {
        for (var t = [categoryUM_A, categoryON_A, categoryO_I, categoryUS_I, categoryIX_ICES], i = 0; i < t.length; i++)
            if (t[i].indexOf(e) > -1)
                return !0;
        var n = categoryIRR.indexOf(e);
        return n % 2 === 0
    }
    for (var E = "", SP = " ", EA = [], N = "number", S = "string", O = "object", A = "array", B = "boolean", R = "regexp", F = "function", BN = "\n", FEATURES = ["tokens", "stresses", "phonemes", "syllables", "pos", "text"], RiTa = {
        VERSION: "1.3.11",
        SPLIT_CONTRACTIONS: !1,
        JAVA: 1,
        JS: 2,
        NODE: 3,
        ...
        random: function() {
            var e = Math.random();
            return arguments.length ? 1 === arguments.length ? e * arguments[0] : e * (arguments[1] - arguments[0]) + arguments[0] : e
        },
        ...
        getPosTags: function(e, t) {
            return t ? tagForWordNet(e) : tagForPENN(e)
        },
        getPosTagsInline: function(e, t) {
            if (!e || !e.length)
                return E;
            t = t || "/",
            e = is(e, S) ? RiTa.tokenize(e) : e;
            for (var i = E, n = RiTa.getPosTags(e), r = 0; r < e.length; r++)
                i += e[r],
                RiTa.isPunctuation(e[r]) || (i += t + n[r]),
                i += SP;
            return i.trim()
        },
        getPresentParticiple: function(e) {
            return Conjugator().getPresentParticiple(e)
        },
        getPastParticiple: function(e) {
            return Conjugator().getPastParticiple(e)
        },
        concordance: function(e, t) {
            return Concorder(e, t).concordance()
        },
        kwic: function(e, t, i) {
            return wordCount = i && i.wordCount || 4,
            Concorder(e, i).kwic(t, wordCount)
        },
        conjugate: function(e, t) {
            return Conjugator().conjugate(e, t)
        },
        ...
        pluralize: function(e) {
            if (!strOk(e))
                return E;
            var t, i, n = PLURAL_RULES;
            if (inArray(MODALS, e.toLowerCase()))
                return e;
            for (t = 0; t < n.length; t++)
                if (i = n[t],
                i.applies(e.toLowerCase()))
                    return i.fire(e);
            return DEFAULT_PLURAL_RULE.fire(e)
        },
        singularize: function(e) {
            if (!strOk(e))
                return E;
            var t, i, n = SINGULAR_RULES;
            if (inArray(MODALS, e.toLowerCase()))
                return e;
            for (t = n.length; t--; )
                if (i = n[t],
                i.applies(e.toLowerCase()))
                    return i.fire(e);
            return this.stem(e, "Pling")
        },
        trim: function(e) {
            return trim(e)
        },
        tokenize: function(e, t) {
            return is(e, S) ? t ? e.split(t) : (e = trim(e),
            e = e.replace(/([\\?!\"\u201C\\.,;:@#$%&])/g, " $1 "),
            e = e.replace(/\\.\\.\\./g, " ... "),
            e = e.replace(/\\s+/g, SP),
            e = e.replace(/,([^0-9])/g, " , $1"),
            e = e.replace(/([^.])([.])([\])}>\"'’]*)\\s*$/g, "$1 $2$3 "),
            e = e.replace(/([\[\](){}<>])/g, " $1 "),
            e = e.replace(/--/g, " -- "),
            e = e.replace(/$/g, SP),
            e = e.replace(/^/g, SP),
            ...
            e = e.replace(/ \u2018/g, " ‘ "),
            e = e.replace(/'([SMD]) /g, " '$1 "),
            RiTa.SPLIT_CONTRACTIONS && (e = e.replace(/([Cc])an['’]t/g, "$1an not"),
            e = e.replace(/([Dd])idn['’]t/g, "$1id not"),
            e = e.replace(/([CcWw])ouldn['’]t/g, "$1ould not"),
            e = e.replace(/([Ss])houldn['’]t/g, "$1hould not"),
            e = e.replace(/ ([Ii])t['’]s/g, " $1t is"),
            e = e.replace(/n['’]t /g, " not "),
            e = e.replace(/['’]ve /g, " have "),
            e = e.replace(/['’]re /g, " are ")),
            e = e.replace(/ ([A-Z]) \\./g, " $1. "),
            e = e.replace(/\\s+/g, SP),
            e = e.replace(/^\\s+/g, E),
            trim(e).split(/\s+/)) : []
        },
        untokenize: function(e, t) {
            t = t || SP;
            for (var i, n, r, s, a, o, u, l = /^[,\.\;\:\?\!\)""“”\u2019‘`']+$/, c = 0, h = /^[\(""“”\u2019‘`']+$/, p = /^[\u2019‘`']+$/, d = /^[\u2019']+$/, g = !1, f = e.length && h.test(e[0]), R = e[0] || E, m = !1, b = 1; b < e.length; b++)
                e[b] && (a = "," === e[b],
                i = l.test(e[b]),
                r = h.test(e[b]),
                u = "," === e[b - 1],
                n = l.test(e[b - 1]),
                s = h.test(e[b - 1]),
                lastEndWithS = "s" === e[b - 1].charAt(e[b - 1].length - 1),
                o = b == e.length - 1,
                c && console.log('before "' + e[b] + '"', b, "inquote? " + f, "thisPunct?", i, "thisQuote", r),
                r ? f ? (g = !0,
                f = !1) : d.test(e[b]) && lastEndWithS || (c && console.log("set withinQuote=1"),
                f = !0,
                g = !1,
                R += t) : g && !i ? (R += t,
                c && console.log("hit1", e[b]),
                g = !1) : s && a ? m = !0 : m && u ? (R += t,
                c && console.log("hit2", e[b]),
                m = !1) : (!i && !s || !o && i && n) && (R += t),
                R += e[b],
                i && !n && !f && p.test(e[b]) && (c && console.log("hitnew", e[b]),
                R += t));
            return R.trim()
        },
        splitSentences: function(e, t) {
            ...
            function n(e) {
                for (var t = 0; t < r.length; t++)
                    for (var i = r[t], n = e.indexOf(i); n > -1; )
                        e = e.replace(i, i.replace(".", s)),
                        n = e.indexOf(i);
                return e
            }
            var r = this.ABBREVIATIONS
              , s = "___"
              , a = new RegExp(s,"g")
              , o = n(e).match(/(\S.+?[.!?])(?=\s+|$)/g);
            return e.length && o && o.length ? i(o) : [e]
        },
        isAbbreviation: function(e, t) {
            var i = function(e) {
                return e && e.length ? e.substring(0, 1).toUpperCase() + e.substring(1) : e
            };
            return t = t || !1,
            e = t ? e : i(e),
            inArray(this.ABBREVIATIONS, e)
        },
        loadString: function(e, t, i) {
            var n = function(e, t, i) {
                ...
                if (s) {
                    var o = function(i) {
                        ...
                        i.on("end", function() {
                            n = n.toString("utf-8").replace(/[\r\n]+/g, r).trim(),
                            a.fireDataLoaded(e, t, n)
                        })
                    }
                      , u = require("http").request(e, o);
                    u.on("socket", function(e) {
                        e.setTimeout(5e3),
                        e.on("timeout", function() {
                            throw u.abort(),
                            Error("[RiTa] loadString timed-out and aborted request")
                        })
                    }),
                    u.end()
                } else {
                    var l = require("fs");
                    l.readFile(e, function(i, n) {
                        if (i || !n)
                            throw err("[Node] Error reading file: " + e + BN + i),
                            i;
                        n = n.toString("utf-8").replace(/[\r\n]+/g, r).trim(),
                        a.fireDataLoaded(e, t, n)
                    })
            ...
            return a.addEventListener("error", function() {
                console.error("[RiTa] loadStrings() unable to load " + e)
            }),
            a.open("GET", e, !0),
            a.onreadystatechange = function() {
                if (4 === a.readyState)
                    if (200 === a.status) {
                        var i = []
                          , n = a.responseText.match(/[^\r\n]+/g);
                        for (var s in n)
                            i[s] = n[s];
                        i = i.join(BN),
                        r.fireDataLoaded(e, t, i)
                    } else
                        console.error("[RiTa] loadString() unable to load: " + e)
            }
            ,
            a.send(null),
            s
        },
        loadStrings: function(e, t, i) {
            var n = function(e, t) {
                function i(i) {
                    i = i.toString("utf-8").trim();
                    var n = i.split(/(\r\n|\n)/gm);
                    s.fireDataLoaded(e, t, n)
                }
                var n = ""
                  , r = /.+?:\/\/.+/.test(e)
                  , s = this;
                if (r) {
                    ...
                    var u = require("fs");
                    u.readFile(e, function(t, n) {
                        if (t || !n)
                            throw err("[Node] Error reading file: " + e + BN + t),
                            t;
                        i(n)
                    })
                }
            ...
            a.onreadystatechange = function() {
                if (4 === a.readyState)
                    if (200 === a.status) {
                        var i = a.responseText.match(/[^\r\n]+/g)
                          , n = [];
                        for (var s in i)
                            n[s] = i[s];
                        r.fireDataLoaded(e, t, n)
                    } else
                        console.error("[RiTa] loadString() unable to load: " + e)
            }
            ,
        ...
        fireDataLoaded: function(e, t, i) {
            return t ? t(i, e) : RiTaEvent({
                name: "RiTaLoader",
                urls: is(e, S) ? [e] : e
            }, DATA_LOADED, i)._fire()
        },
        isQuestion: function(e) {
            for (var t = RiTa.tokenize(e), i = 0; i < QUESTION_STARTS.length; i++)
                if (equalsIgnoreCase(t[0], QUESTION_STARTS[i]))
                    return !0;
            return !1
        },
        isSentenceEnd: function(e, t) {
            if (!is(e, S) || !is(t, S))
                return !1;
            var i = e.charAt(0)
              , n = e.length;
            if (RiTa.isAbbreviation(e))
                return !1;
            if (n > 1 && i.indexOf("`'\"([{<") != -1 && RiTa.isAbbreviation(e.substring(1)))
                return !1;
            if (n > 2 && ("'" == e.charAt(0) && "'" == e.charAt(1) || "`" == e.charAt(0) && "`" == e.charAt(1)) && RiTa.isAbbreviation(e.substring(2)))
                return !1;
            var r = t.length
              , s = e.charAt(n - 1)
              , a = n > 1 ? e.charAt(n - 2) : SP
              , o = n > 2 ? e.charAt(n - 3) : SP
              , u = t.charAt(0)
              , l = r > 1 ? t.charAt(1) : SP
              , c = r > 2 ? t.charAt(2) : SP;
            return (u == u.toUpperCase() || l == l.toUpperCase() && u.indexOf("`'\"([{<") != -1 || c == c.toUpperCase() && ("`" == u && "`" == l || "'" == u && "'" == l) || "_" == t || "<" == u) && ("?" == s || "!" == s || a.indexOf("?!.") != -1 && s.indexOf("\"'}>)") != -1 || o.indexOf("?!.") != -1 && "'" == a && "'" == s || "." == s && ((2 != n || a != a.toUpperCase()) && (4 != n || "." != o || a != a.toUpperCase() || e.charAt(0) != e.charAt(0).toUpperCase())))
        },
        isW_Question: function(e) {
            for (var t = RiTa.tokenize(e), i = 0; i < W_QUESTION_STARTS.length; i++)
                if (equalsIgnoreCase(t[0], W_QUESTION_STARTS[i]))
                    return !0;
            return !1
        },
        unescapeHTML: function(e) {
            ...
            return String.fromCharCodePoint = function() {
                for (var e = [], t = 0; t < arguments.length; t++) {
                    var i = arguments[t];
                    arguments[t] < 65536 ? e.push(arguments[t]) : arguments[t] < 1114112 && (i -= 65536,
                    e.push((i >> 10 & 1023) + 55296),
                    e.push((1023 & i) + 56320))
                }
            ...
            t = t.replace(/&#(\d+);/g, function(e, t) {
                return String.fromCharCodePoint(parseInt(t, 10))
            }).replace(/&#x([0-9a-f]+);/gi, function(e, t) {
                return String.fromCharCodePoint(parseInt(t, 16))
            })
        },
        randomOrdering: function(e) {
            var t = [];
            if (e) {
                for (var i = 0; i < e; i++)
                    t.push(i);
                for (var n, r, s = t.length; s; n = parseInt(Math.random() * s),
                r = t[--s],
                t[s] = t[n],
                t[n] = r)
                    ;
        ...
        trimPunctuation: function(e) {
            if (!is(e, S))
                return e;
            var t = "[�`~\"/\\'_\\-[\\]{}()*+!?%&.,\\\\^$|#@<>|+=;:‘’“”]"
              , i = new RegExp("^" + t + "+|" + t + "+$","g");
            return e === E ? E : e.replace(i, E)
        },
        stripPunctuation: function(e) {
            return e === E ? E : e.replace(PUNCTUATION_CLASS, E)
        },
        isPunctuation: function(e) {
            return !(!e || !e.length) && ONLY_PUNCT.test(e)
        },
        hasPunctuation: function(e) {
            return !(!e || !e.length) && ONLY_PUNCT.test(e)
        },
        env: function() {
        ...
        getPhonemes: function(e) {
            return RiString(e).analyze().get(RiTa.PHONEMES)
        },
        getStresses: function(e) {
            return RiString(e).analyze().get(RiTa.STRESSES)
        },
        getSyllables: function(e) {
            return RiString(e).analyze().get(RiTa.SYLLABLES)
        },
        getWordCount: function(e) {
            return RiTa.tokenize(e).length
        },
        stem: function(e, t) {
            if (t = t || "Porter",
            "Lancaster" != t && "Porter" != t && "Pling" != t && err("Bad stemmer type: " + t),
            e.indexOf(SP) < 0)
                return RiTa.stemmers[t](e);
            e = e.replace(/[^\w]/g, SP).replace(/\s+/g, SP);
            for (var i = [], n = e.split(SP), r = 0; r < n.length; r++)
                i.push(RiTa.stemmers[t](n[r]));
            return i.join(SP)
        },
        minEditDistance: function(e, t, i) {
            var n = i ? MinEditDist.computeAdjusted : MinEditDist.computeRaw;
            return n.call(MinEditDist, e, t)
        }
    }, i = 0; i < FEATURES.length; i++)
        RiTa[FEATURES[i].toUpperCase()] = FEATURES[i];
    var RiLexicon = makeClass();
    RiLexicon.SILENCE_LTS = !1,
    RiLexicon.prototype = {
        init: function() {
            "undefined" == typeof _dict ? (this.data = {},
            this.keys = []) : this.reload()
        },
        clear: function() {
            this.data = {},
            this.keys = []
        ...
        reload: function() {
            "undefined" != typeof _dict && (this.data = _dict(),
            this.keys = okeys(this.data))
        },
        addWord: function(e, t, i) {
            return this.data[e.toLowerCase()] = [t.toLowerCase(), i.toLowerCase()],
            this.keys = okeys(this.data),
            this
        },
        similarByLetter: function(e, t, i) {
            var n = Number.MAX_VALUE
              , r = 2
              , s = [];
            if (!e || !e.length)
                return EA;
            2 == arguments.length && is(t, B) && (i = t,
            t = 1),
            e = e.toLowerCase(),
            t = t || 1,
            i = i || !1;
            for (var a, o = e + "s", u = e + "es", l = e.length, c = 0; c < this.size(); c++) {
                var h = this.keys[c];
                h.length < r || i && h.length != l || h !== e && h !== o && h !== u && (a = MinEditDist.computeRaw(h, e),
                a >= t && a < n ? (n = a,
                s = [h]) : a === n && s.push(h))
            }
            return s
        },
        similarBySound: function(e, t, i) {
            t = t || 1;
            var n, r, s, a = Number.MAX_VALUE, o = [], u = i || 2, l = RiTa.getPhonemes(e), c = l ? l.split("-") : [], h = e + "s", p = e + "es";
            if (!c[0] || !e || !e.length)
                return EA;
            for (var d = 0; d < this.size(); d++)
                n = this.keys[d],
                n.length < u || n !== e && n !== h && n !== p && (l = this.data[n][0],
                r = l.replace(/1/g, E).replace(/ /g, "-").split("-"),
                s = MinEditDist.computeRaw(r, c),
                s >= t && s < a ? (a = s,
                o = [n]) : s === a && o.push(n));
            return o
        },
        similarBySoundAndLetter: function(e) {
            function t() {
                var e, t, i, n = [], r = {}, s = 0, a = arguments.length - 1, o = arguments[0].length;
                for (e = 0; e <= a; e++)
                ...
                for (e = 0; e <= a; e++) {
                    ...
                    for (var u = 0; u < i; u++) {
                        var l = arguments[t][u];
                        r[l] === e - 1 ? e === a ? (n.push(l),
                        r[l] = 0) : r[l] = e : 0 === e && (r[l] = 0)
                    }
                }
                return n
            }
            var i, n = [], r = this.similarByLetter(e);
            return r.length < 1 ? n : (i = this.similarBySound(e),
            i.length < 1 ? n : t(i, r))
        },
        substrings: function(e, t) {
            t = t || 0 === t || 4;
            for (var i = [], n = 0; n < this.size(); n++)
                this.keys[n] === e || this.keys[n].length < t || e.indexOf(this.keys[n]) >= 0 && i.push(this.keys[n]);
            return i
        },
        superstrings: function(e) {
            for (var t = [], i = 0; i < this.size(); i++)
                this.keys[i] !== e && this.keys[i].indexOf(e) >= 0 && t.push(this.keys[i]);
            return t
        },
        words: function() {
            var e, t = arguments, i = !1, n = [];
            switch (t.length) {
            case 2:
                is(t[0], B) ? (i = t[0],
                e = is(t[1], R) ? t[1] : new RegExp(t[1])) : (i = t[1],
                e = is(t[0], R) ? t[0] : new RegExp(t[0]));
                break;
            case 1:
                if (is(t[0], B))
                    return t[0] ? shuffle(this.keys) : this.keys;
                e = is(t[0], R) ? t[0] : new RegExp(t[0]);
                break;
            case 0:
                return this.keys
            ...
            for (var r = 0; r < this.size(); r++)
                e.test(this.keys[r]) && n.push(this.keys[r]);
            return i ? shuffle(n) : n
        },
        _isVowel: function(e) {
            return strOk(e) && RiTa.VOWELS.indexOf(e) > -1
        },
        _isConsonant: function(e) {
            return typeof e === S && 1 === e.length && RiTa.VOWELS.indexOf(e) < 0 && /^[a-z\u00C0-\u00ff]+$/.test(e)
        },
        _isPlural: function(e) {
            if (NULL_PLURALS.applies(e))
                return !0;
            var t = RiTa.stem(e, "Pling");
            if (t === e)
                return !1;
            var i = RiTa.singularize(e)
              , n = this.data[i];
            if (n && 2 === n.length) {
                for (var r = n[1].split(SP), s = 0; s < r.length; s++)
                    if ("nn" === r[s])
                        return !0
            } else if ((e.endsWith("ses") || e.endsWith("zes")) && (i = e.substring(0, e.length - 1),
            n = this.data[i],
            n && 2 === n.length))
                for (var r = n[1].split(SP), s = 0; s < r.length; s++)
                    if ("nn" === r[s])
        ...
        containsWord: function(e) {
            return !(!this.data || !strOk(e)) && (e = e.toLowerCase(),
            this.data[e] || this._isPlural(e))
        },
        isRhyme: function(e, t, i) {
            var n = this._getRawPhones(e, i)
              , r = this._getRawPhones(t, i);
            if (!strOk(e) || !strOk(t) || equalsIgnoreCase(e, t) || r === n)
                return !1;
            var s = this._lastStressedVowelPhonemeToEnd(e, i)
              , a = this._lastStressedVowelPhonemeToEnd(t, i);
            return strOk(s) && strOk(a) && s === a
        },
        rhymes: function(e) {
            for (var t, i = this._lastStressedPhoneToEnd(e), n = [], r = 0; r < this.size(); r++)
                this.keys[r] !== e && (t = this.data[this.keys[r]][0],
                endsWith(t, i) && n.push(this.keys[r]));
            return n.length > 0 ? n : EA
        },
        alliterations: function(e, t, i) {
            if (e.indexOf(" ") > -1)
                return [];
            if (this._isVowel(e.charAt(0)))
                return [];
            t = t || 4;
            for (var n, r = [], s = this._firstPhoneme(this._firstStressedSyllable(e, i)), a = 0; a < this.size(); a++) {
                if (n = this._firstPhoneme(this._firstStressedSyllable(this.keys[a], i)),
                n._isVowel)
                    return [];
                n && s === n && this.keys[a].length >= t && r.push(this.keys[a])
            }
            return shuffle(r)
        },
        isAlliteration: function(e, t, i) {
            if (!strOk(e) || !strOk(t) || e.indexOf(" ") > -1 || t.indexOf(" ") > -1)
                return !1;
            var n = this._firstPhoneme(this._firstStressedSyllable(e, i))
              , r = this._firstPhoneme(this._firstStressedSyllable(t, i));
            return !this._isVowel(n.charAt(0)) && !this._isVowel(r.charAt(0)) && (strOk(n) && strOk(r) && n === r)
        },
        _firstSyllable: function(e, t) {
            var i = this._getRawPhones(e, t);
            if (!strOk(i))
                return E;
            "URL" === e && console.log(i);
            var n = i.split(" ");
        ...
        _firstStressedSyllable: function(e, t) {
            var i, n, r = this._getRawPhones(e, t), s = -1;
            if (!strOk(r))
                return E;
            if (s = r.indexOf(RiTa.STRESSED),
            s < 0)
                return E;
            for (i = r.charAt(--s); " " != i; ) {
                if (--s < 0) {
            ...
            return n = 0 === s ? r : trim(r.substring(s)),
            s = n.indexOf(" "),
            s < 0 ? n : n.substring(0, s)
        },
        isVerb: function(e) {
            return this._checkType(e, PosTagger.VERBS)
        },
        isNoun: function(e) {
            var t = this._checkType(e, PosTagger.NOUNS);
            if (!t) {
                var i = RiTa.singularize(e);
                i !== e && (t = this._checkType(i, PosTagger.NOUNS))
            }
            return t
        },
        isAdverb: function(e) {
            return this._checkType(e, PosTagger.ADV)
        },
        isAdjective: function(e) {
            return this._checkType(e, PosTagger.ADJ)
        },
        size: function() {
            var e = this.keys.length;
            return RiTa.LEX_WARN && 0 === e && (warn(RiTa.LEX_WARN),
            RiTa.LEX_WARN = 0),
            e
        },
        _checkType: function(e, t) {
            if (e && e.indexOf(SP) != -1)
                throw Error("[RiTa] _checkType() expects a single word, found: " + e);
            var i = this._getPosArr(e);
            RiTa.LEX_WARN && i.length < 1 && this.size() <= 1e3 && (warn(RiTa.LEX_WARN),
            RiTa.LEX_WARN = 0);
            for (var n = 0; n < i.length; n++)
                if (t.indexOf(i[n]) > -1)
                    return !0;
        ...
        _getSyllables: function(e) {
            if (!strOk(e))
                return E;
            for (var t = RiTa.tokenize(e), i = [], n = 0; n < t.length; n++)
                i[n] = this._getRawPhones(t[n]).replace(/\s/g, "/");
            return RiTa.untokenize(i).replace(/1/g, E).trim()
        },
        _getPhonemes: function(e) {
            if (!strOk(e))
                return E;
            for (var t = RiTa.tokenize(e), i = [], n = 0; n < t.length; n++)
                if (!RiTa.isPunctuation(t[n])) {
                    if (i[n] = this._getRawPhones(t[n]),
                    !i[n].length)
                        return E;
                    i[n] = i[n].replace(/ /g, "-")
                }
        ...
        _getStresses: function(e) {
            var t, i, n = [], r = [], s = is(e, A) ? e : RiTa.tokenize(e);
            if (!strOk(e))
                return E;
            for (t = 0; t < s.length; t++)
                RiTa.isPunctuation(s[t]) || (r[t] = this._getRawPhones(s[t]));
            for (t = 0; t < r.length; t++)
                if (r[t]) {
                    i = r[t].split(SP);
                    for (var a = 0; a < i.length; a++) {
                        var o = i[a].indexOf(RiTa.STRESSED) > -1 ? RiTa.STRESSED : RiTa.UNSTRESSED;
                        a > 0 && (o = "/" + o),
                        n.push(o)
                    }
                }
            return n.join(SP).replace(/ \//g, "/")
        },
        lexicalData: function(e) {
            return 1 === arguments.length ? (this.data = e,
            this) : this.data
        },
        _lookupRaw: function(e) {
            if (e = e && e.toLowerCase(),
            this.data && this.data[e])
                return this.data[e]
        },
        _getRawPhones: function(e, t) {
            var i, n, r = this._lookupRaw(e);
            return t = t || !1,
            (r === undefined || t && !RiTa.SILENT && !RiLexicon.SILENCE_LTS) && (n = this._letterToSound(),
            i = n && n.getPhones(e),
            i && i.length) ? RiString._syllabify(i) : r && 2 === r.length ? r[0] : E
        },
        _getPosData: function(e) {
            var t = this._lookupRaw(e);
            return t && 2 === t.length ? t[1] : E
        },
        _getPosArr: function(e) {
            var t = this._getPosData(e);
            return strOk(t) ? t.split(SP) : EA
        },
        _getBestPos: function(e) {
            var t = this._getPosArr(e);
            return t.length > 0 ? t[0] : []
        },
        _firstPhoneme: function(e) {
            if (!strOk(e))
                return E;
            var t = e.split(RiTa.PHONEME_BOUNDARY);
            return t ? t[0] : E
        },
        _firstConsonant: function(e) {
            if (!strOk(e))
                return E;
            var t = e.split(RiTa.PHONEME_BOUNDARY);
            if (t)
                for (var i = 0; i < t.length; i++)
                    if (this._isConsonant(t[i].charAt(0)))
                        return t[i];
            return E
        },
        _lastStressedVowelPhonemeToEnd: function(e, t) {
            if (!strOk(e))
                return E;
            var i = this._lastStressedPhoneToEnd(e, t);
            if (!strOk(i))
                return E;
            var n = i.split(" ")
              , r = n[n.length - 1];
            ...
            return e + " " + i + " last:" + r + " idx=" + s + " result:" + r.substring(s),
            r.substring(s)
        },
        _lastStressedPhoneToEnd: function(e, t) {
            if (!strOk(e))
                return E;
            var i, n, r, s = this._getRawPhones(e, t);
            if (!strOk(s))
                return E;
            if (i = s.lastIndexOf(RiTa.STRESSED),
            i < 0)
                return E;
            for (n = s.charAt(--i); "-" != n && " " != n; ) {
                if (--i < 0)
                    return s;
                n = s.charAt(i)
            }
            return r = s.substring(i + 1)
        },
        randomWord: function() {
            var e, t, i, n, r = !1, s = Math.floor(Math.random() * this.size()), a = arguments, o = this.keys, u = function(e, t) {
                return !!(e.endsWith("ness") || e.endsWith("ism") || t.indexOf("vbg") > 0)
            };
            switch ("string" == typeof a[0] && (a[0] = trim(a[0]).toLowerCase(),
            r = "nns" === a[0],
            "v" === a[0] && (a[0] = "vb"),
            "r" === a[0] && (a[0] = "rb"),
            "a" === a[0] && (a[0] = "jj"),
            "n" !== a[0] && "nns" !== a[0] || (a[0] = "nn")),
            a.length) {
            case 2:
                for (e = 0; e < o.length; e++)
                    if (t = (s + e) % o.length,
                    i = this.data[o[t]],
                    n = i[0].split(SP).length,
                    n === a[1] && a[0] === i[1].split(SP)[0]) {
                        if (!r)
                            return o[t];
                        if (!u(o[t], i[1]))
                            return RiTa.pluralize(o[t])
                    }
            case 1:
                if (is(a[0], S)) {
                    for (e = 0; e < o.length; e++)
        ...
        _letterToSound: function() {
            return this.lts || "undefined" != typeof LetterToSound && (this.lts = new LetterToSound),
            this.lts
        }
    };
    var RiMarkov = makeClass();
    RiMarkov.MAX_GENERATION_ATTEMPTS = 5e3;
    var SSRE = /"?[A-Z][a-z"',;`-]*/
      , SSDLM = "D=l1m_";
    RiMarkov.prototype = {
        init: function(e, t, i) {
            var n = this._initArgs.apply(this, arguments);
            ok(n[0], N),
            this.N = n[0],
            this.rawText = "",
            this.pathTrace = [],
            ...
            this.isSentenceAware = !(n.length > 1 && !n[1]),
            this.allowDuplicates = !(n.length > 2 && !n[2]),
            this.printIgnoredText = !1
        },
        _initArgs: function() {
            var e = arguments
              , t = get(e[0]);
            return !e.length || t !== O && "global" !== t && "window" !== t ? e : this._initArgs.apply(this, Array.prototype.slice.call(e, 1))
        },
        getProbability: function(e) {
            this.root || err("Model not initd: null root!");
            var t = is(e, S) ? this.root.lookup(e) : this._findNode(e);
            return t ? t.probability() : 0
        },
        getProbabilities: function(e) {
            is(e, S) && (e = [e]),
            e.length > this.N && (e = e.slice(Math.max(0, e.length - (this.N - 1)), e.length));
            var t = {}
              , i = this._findNode(e);
            if (!i)
                return {};
            for (var n = i.childNodes(), r = 0; r < n.length; r++) {
                var s = n[r];
                s && (t[s.token] = s.probability())
            }
            return t
        },
        getCompletions: function(e, t) {
            var i, n, r, s, a = [];
            if (t) {
                if (e.length + t.length > this.N && err("Sum of pre.length && post.length must be < N, was " + (e.length + t.length)),
                i = this._findNode(e),
                !i)
                    return null;
                s = i.childNodes();
                for (var o = 0; o < s.length; o++) {
                    ...
                    for (var u = 0; u < t.length; u++)
                        r.push(t[u]);
                    this._findNode(r) && a.push(n.token)
                }
                return a
            }
            var l = this.getProbabilities(e);
            return okeys(l).sort(function(e, t) {
                return l[t] - l[e]
            })
        },
        generateUntil: function(e, t, i) {
            t = t || 1,
            i = i || Number.MAX_VALUE;
            var n, r, s = 0, a = 999;
            e: for (; ++s < a; )
                for (r = this.generateTokens(t); r.length < i; ) {
                    if (n = this._nextNodeForArr(r),
                    !n || !n.token)
                        continue e;
                    if (r.push(n.token),
                    n.token.search(e) > -1)
            ...
            return s >= a && err(BN + "RiMarkov failed to complete after " + s + " attempts.You may need to add more text to your model..." + BN),
            r
        },
        generateTokens: function(e) {
            var t, i = 0, n = 500, r = [], s = [];
            e: for (; ++i < n; )
                if (t = this.root.selectChild(null, !0),
                t && t.token) {
                    for (r.push(t); r.length < e; ) {
                        if (t = this._nextNodeForArr(r),
                        !t || !t.token) {
                            r = [];
                            continue e
                        }
            ...
            r.length < e && this._onGenerationIncomplete(i, r.length);
        ...
        sentenceAware: function() {
            if (arguments.length > 0)
                throw Error("sentenceAware() takes no arguments, instead use the constructor RiMarkov(n, recognizeSentences);");
            return this.isSentenceAware
        },
        print: function() {
            return console && console.log(this.root.asTree(!1)),
            this
        },
        ready: function(e) {
            return this.size() > 0
        },
        loadFrom: function(e, t, i, n) {
            var r = this;
            is(e, S) || ok(e, A),
            is(t, F) ? (n = t,
            t = undefined) : is(i, F) && (n = i,
            i = undefined),
            RiTa.loadStrings(e, function(e) {
                e = e.join(BN),
                r.loadText(e, t, i),
                n && is(n, F) && n(e)
            })
        },
        loadText: function(e, t, i, n) {
            ok(e, S),
            this.rawText += e,
            t = Math.round(t || 1);
            var r = this.isSentenceAware ? this._loadSentences(e, t, n) : this.loadTokens(RiTa.tokenize(e, i), t);
            return r
        },
        loadTokens: function(e, t) {
            t = Math.round(t || 1),
            this.root.count += e.length;
            for (var i, n = 0; n < e.length; n++) {
                i = [];
                for (var r = 0; r < this.N; r++)
                    n + r < e.length ? i[r] = e[n + r] ? e[n + r] : null : i[r] = null;
                for (var s = 0; s < t; s++)
                    for (var a = this.root, o = 0; o < i.length; o++)
                        a.token && (a = a.addChild(i[o], 1))
            }
            return this
        },
        ...
        generateSentences: function(e) {
            this.isSentenceAware || err("generateSentences() can only be called when the model is in 'sentence-aware' mode, otherwise use generateTokens()");
            for (var t = this._getSentenceStart(), i = t.token + SP, n = [], r = 0, s = 0, a = 1; n.length < e; )
                if (a >= this.maxSentenceLength && (t = this._getSentenceStart(),
                i = t.token + SP,
                a = 1),
                t.isLeaf())
                    t = this._tracePathFromRoot(t);
                else if (t = this._nextNodeForNode(t),
                t.isSentenceStart) {
                    if (a >= this.minSentenceLength) {
                        var o = RiTa.untokenize(i.trim().split(/\s+/));
                        o = o.replace(/(.)\( /, "$1 ("),
                        this._validateSentence(o) && (n.indexOf(o) < 0 && n.push(o),
                        s += r,
                        r = 0)
                    }
                    t = this._getSentenceStart(),
                    i = t.token + SP,
                    a = 1
                } else if (a++,
                i += t.token + SP,
                ++r >= RiMarkov.MAX_GENERATION_ATTEMPTS) {
                    this._onGenerationIncomplete(s += r, n.length);
                    break
                }
            return n
        },
        _validateSentence: function(e) {
            var t = RiTa.tokenize(e)
              , i = t[0]
              , n = t[t.length - 1];
            if (!i.match(/[A-Z]\S*/))
                return this.printIgnoredText && log("Skipping: bad first char in '" + e + "'"),
                !1;
            if (!n.match(/[!?.]/))
                return this.printIgnoredText && log("Bad last token: '" + n + "' in: " + e),
                !1;
            if (!this.allowDuplicates && (this.isSentenceAware || err("Invalid state: allowDuplicates must be true when not generating sentences"),
            this.rawText.indexOf(e) > -1))
                return ++this.skippedDups >= RiMarkov.MAX_GENERATION_ATTEMPTS && (this.allowDuplicates = !0,
                this.skippedDups = 0),
                this.printIgnoredText && console.log("Ignoring duplicate: " + e),
                !1;
            var r = e.split(/\s+/);
            return !RiTa.isAbbreviation(r[r.length - 1])
        },
        _tracePathFromRoot: function(e) {
            e.pathFromRoot(this.pathTrace),
            this.pathTrace.pop();
            for (var t = this.root; this.pathTrace.length; ) {
                var i = this.pathTrace.pop();
                t = t.lookup(i)
            }
            return t
        },
        _nextNodeForArr: function(e) {
            for (var t = Math.max(0, e.length - (this.N - 1)), i = this.root.lookup(e[t++]), n = t; n < e.length; n++)
                i && (i = i.lookup(e[n]));
            return i ? i.selectChild(null, !0) : null
        },
        _nextNodeForNode: function(e) {
            for (var t, i = 0, n = 0, r = e.childNodes(), s = 1e3; ; ) {
                n = 0,
                t = Math.random();
                for (var a = 0, o = r.length; a < o; a++)
                    if (n += r[a].probability(),
                    (!e.isRoot() || !this.isSentenceAware || r[a].isSentenceStart) && t < n)
                        return r[a];
                i++,
                warn("Prob. miss (#'+attempts+') in RiMarkov.nextNode(). Make sure there are a sufficient\n       # of sentences in the model that are longer than 'minSentenceLength'"),
                i == s && err("PROB. MISS" + e + " total=" + n + " selector=" + t)
            }
        },
        _clean: function(e) {
            return RiTa.trim(e.replace(/\s+/, SP))
        },
        _onGenerationIncomplete: function(e, t) {
            warn(BN + "RiMarkov failed to complete after " + e + " tries and " + t + " successful generations. You may need to add more text to the model..." + BN)
        },
        _loadSentences: function(e, t, i) {
            var n, r, s, a, o = [], u = RiTa.splitSentences(e), l = Math.round(t || 1);
            for (n = 0; n < u.length; n++)
                if (a = RiTa.tokenize(this._clean(u[n])),
                this._validSentenceStart(a[0]))
                    for (o.push(SSDLM + a[0]),
                    r = 1; r < a.length; r++)
                        o.push(a[r]);
                else
                    this.printIgnoredText && warn("Skipping (bad sentence start): " + a);
            for (n = 0; n < o.length; n++) {
                for (s = [],
                r = 0; r < this.N; r++)
                    n + r < o.length && (s[r] = o[n + r]);
                for (r = 0; r < l; r++)
                    this._addSentenceSequence(s);
                !i || n % 1e4 || printProgress("Building model: ", parseInt(n / o.length * 1e3) / 10)
            }
            return i && printProgress("Building model: ", 100, 0),
            this.root.count += o.length,
            this
        },
        size: function() {
            return this.root.count
        },
        _validSentenceStart: function(e) {
            return !this.isSentenceAware || e && e.match(SSRE)
        },
        _addSentenceSequence: function(e) {
            for (var t = this.root, i = 0; i < e.length; i++)
                if (e[i] && t.token) {
                    var n = e[i];
                    if (startsWith(n, SSDLM)) {
                        n = n.substring(SSDLM.length);
                        var r = t;
                        t = t.addChild(n, 1),
                        t.isSentenceStart = !0,
                        r.isRoot() && this.sentenceStarts.push(t.token)
                    } else
                        t = t.addChild(n, 1)
                }
        },
        _getSentenceStart: function() {
            return this.isSentenceAware || err("getSentenceStart() can only be called when the model is in 'sentence-aware' mode..."),
            this.sentenceStarts && this.sentenceStarts.length || err("No sentence starts found! genSen=" + this.isSentenceAware),
            this.root.lookup(RiTa.randomItem(this.sentenceStarts))
        },
        _findNode: function(e) {
            if (!e || !is(e, A) || !e.length)
                return null;
            var t = this.N
              , i = (Math.min(e.length, t - 1),
            Math.max(0, e.length - (t - 1)))
              , n = this.root.lookup(e[i++]);
            if (!n)
                return null;
            var r = 0
              , s = [];
    ...
    RiString._phones = {
        ...
        digits: ["z-ih-r-ow", "w-ah-n", "t-uw", "th-r-iy", "f-ao-r", "f-ay-v", "s-ih-k-s", "s-eh1-v-ax-n", "ey-t", "n-ih-n"]
    },
    RiString._syllabify = function(e) {
        for (var t, i, n = function(e) {
            ...
            return n.join(SP)
        }, r = [], s = [], a = "string" == typeof e ? e.split("-") : e, o = 0; o < a.length; o++) {
            var u = a[o].trim()
              , l = i;
            if (u.length)
                if (isNum(last(u)) && (l = parseInt(last(u)),
                u = u.substring(0, u.length - 1)),
                t && log(o + ")" + u + " stress=" + l + " inter=" + r.join(":")),
                inArray(RiString._phones.vowels, u)) {
                    for (var c = i, h = i, p = 0; p < r.length + 1; p++) {
                        c = r.slice(0, p),
                        h = r.slice(p, r.length),
                        t && log("  " + p + ") onset=" + h.join(":") + "  coda=" + c.join(":") + "  inter=" + r.join(":"));
                        var d = inArray(RiString._phones.onsets, h.join(" "));
                        if (d || 0 === s.length || 0 === h.length) {
                            t && log("  break " + u);
                            break
                        }
                    }
                    s.length > 0 && (extend(s[s.length - 1][3], c),
                    t && log("  tack: " + c + " -> len=" + s[s.length - 1][3].length + " [" + s[s.length - 1][3] + "]"));
                    var g = [[l], h, [u], []];
                    s.push(g),
                    r = []
                } else {
                    if (!inArray(RiString._phones.consonants, u) && " " != u)
                        throw Error("Invalid phoneme: " + u);
                    r.push(u)
                }
        }
        return r.length > 0 && (0 === s.length ? s.push([[i], r, [], []]) : extend(s[s.length - 1][3], r)),
        n(s)
    }
    ,
    RiString.prototype = {
        init: function(e) {
            is(e, N) && (e = String.fromCharCode(e)),
            e = e || "",
            this.x = 0,
            this.y = 0,
            this.z = 0,
        ...
        features: function() {
            return this._features || this.analyze(),
            this._features
        },
        analyze: function() {
            var e, t, i, n, r, s = E, a = E, o = E, u = "/", l = "-", c = RiTa.tokenize(this._text), h = RiTa.lexicon;
            this._features || initFeatureMap(this),
            this._features.tokens = c.join(SP),
            this._features.pos = RiTa.getPosTags(this._text).join(SP);
            for (var p = 0, d = c.length; p < d; p++) {
                if (r = !1,
                t = h._getRawPhones(c[p]),
                t || (i = h._letterToSound(),
                n = i && i.getPhones(c[p]),
                n && n.length > 0 ? (c[p].match(/[a-zA-Z]+/) && log("[RiTa] Used LTS-rules for '" + c[p] + "'"),
                t = RiString._syllabify(n)) : (t = c[p],
                r = !0)),
                s += t.replace(/[0-2]/g, E).replace(/ /g, l) + SP,
                a += t.replace(/ /g, u).replace(/1/g, E) + SP,
                r)
                    o += c[p];
                else {
                    e = t.split(SP);
                    for (var g = 0; g < e.length; g++)
                        e[g].length && (o += e[g].indexOf(RiTa.STRESSED) > -1 ? RiTa.STRESSED : RiTa.UNSTRESSED,
                        g < e.length - 1 && (o += u))
                }
                endsWith(o, SP) || (o += SP)
            }
            return o = o.trim(),
            s = s.trim().replace(/\\s+/, SP),
            a = a.trim().replace(/\\s+/, SP),
            this._features.stresses = o,
            this._features.phonemes = s,
            this._features.syllables = a,
            this
        },
        get: function(e) {
            this._features || this.analyze();
            var t = this._features[e];
            return !t && FEATURES.indexOf(e) > -1 && !this._features.hasOwnProperty(e) && (this.analyze(),
            t = this._features[e]),
            t
        },
        set: function(e, t) {
        ...
        endsWith: function(e) {
            return endsWith(this._text, e)
        },
        equals: function(e) {
            return is(e.text, F) && e.text() === this._text
        },
        equalsIgnoreCase: function(e) {
            return typeof e === S ? e.toLowerCase() === this._text.toLowerCase() : e.text().toLowerCase() === this._text.toLowerCase()
        },
        text: function(e) {
            return arguments.length > 0 ? (this._text = e,
            initFeatureMap(this),
            this) : this._text
        },
        pos: function() {
            for (var e = RiTa.tokenize(this._text), t = PosTagger.tag(e), i = 0, n = t.length; i < n; i++)
                strOk(t[i]) || err("RiString: can't parse pos for:" + e[i]);
            return t
        },
        posAt: function(e) {
            var t = this.pos();
            return t && t.length ? t[Math.min(e < 0 ? t.length + e : e, t.length - 1)] : E
        },
        wordAt: function(e) {
            var t = this.words();
            return e < 0 || e >= t.length ? E : t[e]
        },
        wordCount: function() {
        ...
        indexOf: function(e, t) {
            return this._text.indexOf(e, t)
        },
        lastIndexOf: function(e, t) {
            return this._text.lastIndexOf(e, t)
        },
        length: function() {
            return this._text.length
        },
        match: function(e) {
            return this._text.match(e) || []
        },
        slice: function(e, t) {
            return this._text.slice(e, t) || E
        },
        insertChar: function(e, t) {
            var i = this.text();
            if (e > i.length || e < -i.length)
                return warn("RiString.insertChar: bad index=" + e),
                this;
            e = e < 0 ? e += i.length : e;
            var n = i.substring(0, e)
              , r = i.substring(e);
            return t && (n += t),
            this.text(n + r)
        },
        removeChar: function(e) {
            var t = this.text();
            return e > t.length || e < -t.length ? (warn("RiString.removeChar: bad index=" + e),
            this) : (e = e < 0 ? e += t.length : e,
            this.text(this._text.substring(0, e).concat(this._text.substring(e + 1))),
            this)
        },
        replaceChar: function(e, t) {
            var i = this.text();
            if (e > i.length || e < -i.length)
                return warn("RiString.replaceChar: bad index=" + e),
                this;
            e = e < 0 ? e += i.length : e,
            i = this.text();
            var n = i.substring(0, e)
        ...
        replaceFirst: function(e, t) {
            if (e && !is(e, S) && e.global) {
                var i = "";
                e.ignoreCase && (i += "i"),
                e.multiline && (i += "m"),
                e.sticky && (i += "y"),
                e = new RegExp(e.source,i)
            }
            return this._text = this._text.replace(e, t),
            this
        },
        replaceAll: function(e, t) {
            var i = "g";
            return e && (t || "" === t) && (!is(e, S) && e.source ? (e.ignoreCase && (i += "i"),
            e.multiline && (i += "m"),
            e.sticky && (i += "y"),
            e = e.source) : e = escapeRegExp(e),
            this._text = this._text.replace(new RegExp(e,i), t)),
            this
        },
        removeWord: function(e) {
            return this.replaceWord(e, E)
        },
        insertWord: function(e, t) {
            var i = this.words();
            return e < 0 && (e += i.length),
            t && t.length >= 0 && e >= 0 && e < i.length && (i[e] = t + SP + i[e],
            this.text(RiTa.untokenize(i))),
            this
        },
        toCharArray: function() {
            return this._text.split(RiTa.E)
        },
        replaceWord: function(e, t) {
            var i = this.words();
            return e < 0 && (e += i.length),
            (t || t === E) && e >= 0 && e < i.length && (i[e] = t,
            this.text(RiTa.untokenize(i))),
            this
        },
        split: function(e, t) {
            for (var i = this._text.split(e, t), n = [], r = 0; r < i.length; r++)
                i[r] && n.push(new RiString(i[r]));
            return n
        },
        ...
        charAt: function(e) {
            return this._text.charAt(e)
        },
        concat: function(e) {
            return this._text.concat(e.text())
        }
    };
    ...
    RiGrammar.prototype = {
        init: function(e) {
            this._rules = {},
            this.execDisabled = !1,
            e && (is(e, S) || is(e, O) && typeof e.loadStrings !== F) && this.load(e)
        },
        ready: function(e) {
            return okeys(this._rules).length > 0
        },
        loadFrom: function(e, t) {
            RiTa.loadStrings(e, function(e) {
                e = e.join(BN),
                this.load(e),
                is(t, F) && t(e)
        ...
        load: function(e) {
            ...
            if ("undefined" != typeof YAML)
                err("Grammar appears to be invalid JSON/YAML, please check it! (http://jsonlint.com/ or http://yamllint.com/)", e);
            else {
                var r = RiTa.env() === RiTa.NODE
                  , s = r ? "require" : "include"
                  , a = r ? "YAML = require('yamljs')" : '<script src="yaml.min.js"></script>';
                err("Grammar appears to be invalid JSON, please check it at http://jsonlint.com/. If you are using YAML, be sure to " + s + " yamljs (https://github.com/jeremyfa/yaml.js), e.g. " + a, e)
            }
        },
        addRule: function(e, t, i) {
            var n = !1;
            i = i || 1,
            n && log('addRule: "' + e + '" : "' + t + '"       [' + get(t) + "]");
            var r = t;
            is(t, A) || (r = t.split(OR_PATT));
            for (var s = 0; s < r.length; s++) {
                ...
                if (u) {
                    if (n)
                        for (log("Found weight for " + a),
                        s = 0; s < u.length; s++)
                            log("  " + s + ") '" + u[s] + "'");
                    a = u[1] + u[3],
                    o = u[2],
                    n && log("weight=" + o + " rule='" + a + "'")
                }
                if (this.hasRule(e)) {
                    n && log("rule exists");
                    var l = this._rules[e];
        ...
        doRule: function(e) {
            var t = function(e) {
                var t, i, n = !1, r = Math.random(), s = 0;
                n && log("getStochasticRule(" + e + ")");
                for (t in e)
                    s += parseFloat(e[t]);
                n && log("total=" + s + "p=" + r);
                for (t in e) {
            ...
            for (n in r)
                i++;
            return i ? 1 == i ? n : t(r) : null
        },
        getGrammar: function() {
            var e = E;
            for (var t in this._rules) {
                e += t + BN;
                var i = this._rules[t];
                for (var n in i)
                    e += "  '" + n + "' [" + i[n] + "]" + BN
        ...
        print: function() {
            if (console) {
                var e = "\n------------------------------";
                console.log(e + BN + this.getGrammar() + e)
            }
            return this
        },
        hasRule: function(e) {
            return "undefined" != typeof this._rules[e]
        },
        expandWith: function(e, t) {
            var i, n = function(e) {
                var t = RiGrammar();
                for (var i in e._rules)
                    t._rules[i] = e._rules[i];
                return t
            }, r = n(this), s = !1;
            for (i in r._rules)
                if (i === t) {
            ...
            s || err("Rule '" + t + "' not found in grammar");
            var o, u = 1e3;
            for (o = 0; o < u; o++) {
                var l = r.expand();
                if (l.indexOf(e) > -1)
            ...
            err("RiGrammar failed to complete after " + o + " tries" + BN)
        },
        expand: function(e) {
            return this.expandFrom(RiGrammar.START_RULE, e)
        },
        expandFrom: function(rule, context) {
            var expandRule = function(e, t) {
                var i, n, r, s, a, o = 0;
                o && log("expandRule(" + t + ")");
                for (var u in e._rules)
                    if (i = e._rules[u],
                    o && log("  name=" + u + "  entry=" + JSON.stringify(i) + "  prod=" + t + (n ? "  idx=" + n : "")),
                    n = t.indexOf(u),
                    n >= 0)
                        return o && log("matched: " + u),
                        r = t.substring(0, n) || E,
                        s = e.doRule(u) || E,
                        a = t.substring(n + u.length) || E,
                        o && log("  pre=" + r + "  expanded=" + s + "  post=" + a + "  result=" + r + s + a),
                        r + s + a;
                return null
            }
              , Scope = function(context) {
                ...
                this.put = function(e, t) {
                    ...
                    this.eval = this.eval(i),
                    this.names.push(e)
                }
                ,
                context) {
                    var scope = this;
                    "function" == typeof context ? scope.put(context.name, context) : "object" == typeof context && okeys(context).forEach(function(e) {
                        "function" == typeof context[e] && scope.put(e, context[e])
                    })
                }
            }
              , handleExec = function(input, context) {
                if (!input || !input.length)
                    return null;
                var res, exec = input.replace(STRIP_TICKS, "$1");
                try {
                    return res = eval(exec),
                    res ? res + E : null
                } catch (e) {
                    if (context)
                        try {
                            return res = new Scope(context).eval(exec),
                            res ? res + "" : null
                        } catch (e) {}
                }
                return input
            }
              , countTicks = function(e) {
                for (var t = 0, i = 0; i < e.length; i++)
                    "`" == e.charAt(i) && t++;
                return t
            };
            okeys(this._rules).length || err("(RiGrammar) No grammar rules found!"),
            this.hasRule(rule) || err("Rule not found: " + rule + BN + "Rules:" + BN + JSON.stringify(this._rules));
            for (var parts, theCall, callResult, tries = 0, maxIterations = 1e3; ++tries < maxIterations; ) {
                ...
                if (next && next.length)
                    ...
                    if (this.execDisabled)
                        break;
                    if (parts = RiGrammar.EXEC_PATT.exec(rule),
                    !parts || !parts.length)
                        break;
                    if (parts.length > 2) {
                        if (theCall = parts[2],
                        2 != countTicks(theCall))
                            return warn("Unable to parse recursive exec: " + theCall + "..."),
                            null;
                        if (callResult = handleExec(theCall, context),
                        !callResult)
                            break;
            ...
            return tries >= maxIterations && log("[WARN] max number of iterations reached: " + maxIterations),
            RiTa.unescapeHTML(rule)
        }
    };
    var callbacksDisabled = !1
      , RiTaEvent = makeClass();
    RiTaEvent.ID = 0,
    RiTaEvent.prototype = {
        init: function(e, t, i) {
            ...
            this._data = i,
            this._source = e,
            this._type = t || RiTa.UNKNOWN
        },
        toString: function() {
            var e = "RiTaEvent[#" + this._id + " type=(" + this._type + ") source=" + this._source.toString();
            return e += this._data ? " data-length=" + this._data.toString().length : e += " data=null",
            e + "]"
        },
        isType: function(e) {
            return this._type === e
        ...
        _fire: function(e) {
            ...
            e && is(e, F))
                try {
                    ...
                    callbacksDisabled = !0;
                    var i = "RiTaEvent: error calling '" + e + "': " + t;
                    throw is(e, S) && (i += " Callback must be a function in JS!"),
                    warn(i),
                    t
                }
        }
    ...
    TextNode.prototype = {
        ...
        selectChild: function(e, t) {
            var i = t || !0;
            return this.children ? this._select(this.childNodes(e), i) : null
        },
        _select: function(e, t) {
            if (!e)
                throw TypeError("bad arg to '_select()'");
            return t = t || !1,
            t ? this._probabalisticSelect(e) : e[Math.floor(Math.random() * e.length)]
        },
        _probabalisticSelect: function(e) {
            if (!e)
                throw TypeError("bad arg to '_probabalisticSelect()'");
            if (!e.length)
                return null;
            if (1 == e.length)
                return e[0];
            for (var t = 0, i = Math.random(), n = 0; n < e.length; n++)
                if (t += e[n].probability(),
                i < t)
                    return e[n];
        ...
        addChild: function(e, t) {
            ...
            return i ? i.count++ : (i = new TextNode(this,e),
            i.count = t,
            this.children[e] = i),
            i
        },
        asTree: function(e) {
            var t = this.token + " ";
            return this.isRoot() || (t += "(" + this.count + ")->"),
            t += "{",
            this.isLeaf() ? t + "}" : this.childrenToString(this, t, 1, e)
        },
        isRoot: function() {
            return !this.parent
        },
        ...
        childNodes: function(e) {
            if (!this.children)
                return EA;
            e = is(e, S) ? new RegExp(e) : e;
            var t = [];
            for (var i in this.children) {
                var n = this.children[i];
                (!e || n && n.token && n.token.search(e) > -1) && t.push(n)
            }
            return t
        },
        siblingCount: function() {
            return this.parent || err("Illegal siblingCount on ROOT!"),
        ...
        childCount: function() {
            ...
            for (var t in this.children)
                t && this.children[t] && (e += this.children[t].count);
            return e
        },
        lookup: function(e) {
            return e ? (e = typeof e != S && e.token ? e.token : e,
            e ? this.children[e] : null) : null
        },
        childrenToString: function(e, t, i, n) {
            var r, s, a, o = e, u = [], l = null, c = BN;
            n = n || !1;
            for (a in e.children)
                u.push(e.children[a]);
            if (!u.length)
            ...
            l); r++) {
                ...
                "\r\n" == h && (h = "\\r\\n")),
                t += c + "'" + h + "'",
                l.count || err("ILLEGAL FREQ: " + l.count + " -> " + o.token + "," + l.token),
                l.isRoot() || (t += " [" + l.count + ",p=" + l.probability().toFixed(3) + "]->{"),
                l.children ? t = this.childrenToString(l, t, i + 1, n) : t += "}"
            }
            for (c = BN,
            s = 0; s < i - 1; s++)
                c += "  ";
    ...
    Conjugator.prototype = {
        init: function() {
            this.perfect = this.progressive = this.passive = this.interrogative = !1,
        ...
        conjugate: function(e, t) {
            ...
            if (!t)
                return e;
            if (i = e.toLowerCase(),
            "am" !== i && "are" !== i && "is" !== i && "was" !== i && "were" !== i || (i = "be"),
            s = i,
            t.number && (this.number = t.number),
            t.person && (this.person = t.person),
            t.tense && (this.tense = t.tense),
            t.form && (this.form = t.form),
            t.passive && (this.passive = t.passive),
            t.progressive && (this.progressive = t.progressive),
            t.interrogative && (this.interrogative = t.interrogative),
            t.perfect && (this.perfect = t.perfect),
            this.form == RiTa.INFINITIVE && (r = "to"),
            this.tense == RiTa.FUTURE_TENSE && (r = "will"),
            this.passive && (o.push(this.getPastParticiple(s)),
            s = "be"),
            this.progressive && (o.push(this.getPresentParticiple(s)),
            s = "be"),
            this.perfect && (o.push(this.getPastParticiple(s)),
            s = "have"),
            r && (o.push(s),
            s = null),
            s)
                if (this.form === RiTa.GERUND) {
                    var u = this.getPresentParticiple(s);
                    o.push(u)
                } else
                    this.interrogative && "be" != s && o.length < 1 ? o.push(s) : (a = this.getVerbForm(s, this.tense, this.person, this.number),
                    o.push(a));
            r && o.push(r),
            n = E;
            for (var l = 0; l < o.length; l++)
                n = o[l] + " " + n;
            return endsWith(n, "peted") && err("Unexpected output: " + this.toString()),
            trim(n)
        },
        checkRules: function(e, t) {
            var i, n = (e.name,
            e.rules), r = e.defaultRule;
            if (n || err("no rule: " + e.name + " of " + t),
            inArray(MODALS, t))
                return t;
            ...
            return e.doubling && inArray(VERB_CONS_DOUBLING, t) && (t = this.doubleFinalConsonant(t)),
            i = r.fire(t)
        },
        doubleFinalConsonant: function(e) {
            return e + e.charAt(e.length - 1)
        },
        getPast: function(e, t, i) {
            if ("be" == e.toLowerCase())
                switch (i) {
                case RiTa.SINGULAR:
                    switch (t) {
            ...
            return this.checkRules(PAST_TENSE_RULESET, e)
        },
        getPresent: function(e, t, i) {
            if (t = t || this.person,
            i = i || this.number,
            t == RiTa.THIRD_PERSON && i == RiTa.SINGULAR)
                return this.checkRules(PRESENT_TENSE_RULESET, e);
            if ("be" == e) {
                if (i != RiTa.SINGULAR)
                    return "are";
                switch (t) {
        ...
        getPresentParticiple: function(e) {
            return strOk(e) ? this.checkRules(PRESENT_PARTICIPLE_RULESET, e) : E
        },
        getPastParticiple: function(e) {
            return strOk(e) ? this.checkRules(PAST_PARTICIPLE_RULESET, e) : E
        },
        getVerbForm: function(e, t, i, n) {
            switch (t) {
            case RiTa.PRESENT_TENSE:
                return this.getPresent(e, i, n);
            case RiTa.PAST_TENSE:
                return this.getPast(e, i, n)
            }
            return e
        },
        toString: function() {
            return "  ---------------------" + BN + "  Passive = " + this.passive + BN + "  Perfect = " + this.perfect + BN + "  Progressive = " + this.progressive + BN + "  ---------------------" + BN + "  Number = " + this.number + BN + "  Person = " + this.person + BN + "  Tense = " + this.tense + BN + "  ---------------------" + BN
        }
    };
    var PosTagger = {
        ...
        DBUG: 0,
        isVerb: function(e) {
            return inArray(this.VERBS, e)
        },
        isNoun: function(e) {
            return inArray(this.NOUNS, e)
        },
        isAdverb: function(e) {
            return inArray(this.ADV, e)
        },
        isAdj: function(e) {
            return inArray(this.ADJ, e)
        },
        hasTag: function(e, t) {
            ok(e, A);
            var i = e.join();
        ...
        tag: function(e) {
            ...
            for (var r = 0, s = e.length; r < s; r++)
                if (e[r].length < 1)
                    t.push(E);
                else if (1 != e[r].length) {
                    var a = n && n._getPosArr(e[r]);
                    if (a.length)
                        t.push(a[0]),
                        i[r] = a;
                    else {
                        i[r] = [];
                        var o = "nn";
                        if (endsWith(e[r], "s") && (o = "nns"),
                        RiTa.SILENT || (RiTa.LEX_WARN && n.size() <= 1e3 && (warn(RiTa.LEX_WARN),
                        RiTa.LEX_WARN = !1),
                        RiTa.LTS_WARN && "undefined" == typeof LetterToSound && (warn(RiTa.LTS_WARN),
                        RiTa.LTS_WARN = !1)),
                        endsWith(e[r], "s")) {
                            var u, l = e[r].substring(0, e[r].length - 1);
                            if (endsWith(e[r], "es") && (u = e[r].substring(0, e[r].length - 2)),
                            this._lexHas("n", l) || u && this._lexHas("n", u))
                                i.push("nns");
                            else {
                                var c = RiTa.singularize(e[r]);
                                this._lexHas("n", c) && i.push("nns")
                            }
                        } else {
                            var c = RiTa.singularize(e[r]);
                            this._lexHas("n", c) ? (i.push("nns"),
                            o = "nns") : checkPluralNoLex(e[r]) && (o = "nns")
                        }
                        t.push(o)
                    }
                } else
                    t.push(this._handleSingleLetter(e[r]));
            return this._applyContext(e, t, i)
        },
        _handleSingleLetter: function(e) {
            var t = e;
            return "a" === e || "A" === e ? t = "dt" : "I" === e ? t = "prp" : e >= "0" && e <= "9" && (t = "cd"),
            t
        },
        _ct: function(e, t, i) {
            this.DBUG && console.log("\n  Custom(" + e + ") tagged '" + t + "' -> '" + i + "'\n\n")
        },
        _applyContext: function(e, t, i) {
            this.DBUG && console.log("ac(" + e + "," + t + "," + i + ")");
            for (var n = startsWith, r = endsWith, s = 0, a = e.length; s < a; s++) {
                var o = e[s]
                  , u = t[s];
                s > 0 && "dt" == t[s - 1] && (n(u, "vb") ? (u = "nn",
                o.match(/^.*[^s]s$/) && (NULL_PLURALS.applies(o) || (u = "nns")),
                this._ct("1a", o, u)) : n(u, "rb") && (u = u.length > 2 ? "jj" + u.charAt(2) : "jj",
                this._ct("1b", o, u))),
                n(u, "n") && !i[s] && isNum(o) && (u = "cd"),
                s > 0 && n(u, "n") && r(o, "ed") && !r(o, "eed") && t[s - 1].match(/^(nn|prp)$/) && (u = "vbn"),
                r(o, "ly") && (u = "rb"),
                n(u, "nn") && r(o, "al") && "mammal" != o && (u = "jj"),
                s > 0 && n(u, "nn") && n(t[s - 1], "md") && (u = "vb"),
                n(u, "nn") && r(o, "ing") && this.hasTag(i[s], "vb") && (u = "vbg",
                this._ct(8, o, u)),
                s > 0 && "nns" == u && this.hasTag(i[s], "vbz") && t[s - 1].match(/^(nn|prp|nnp)$/) && (u = "vbz",
                this._ct(9, o, u)),
                n(u, "nn") && o.charAt(0) === o.charAt(0).toUpperCase() && (0 != s || 1 === e.length || 0 == s && !this._lexHas("nn", RiTa.singularize(o).toLowerCase())) && (u = r(u, "s") ? "nnps" : "nnp",
                this._ct(10, o, u)),
                s < t.length - 1 && "nns" == u && n(t[s + 1], "rb") && this.hasTag(i[s], "vbz") && (u = "vbz",
                this._ct(11, o, u)),
                "nns" === u && (s > 0 && ["nn", "prp", "cc", "nnp"].indexOf(t[s - 1]) > -1 ? this._lexHas("vb", RiTa.singularize(o)) && (u = "vbz",
                this._ct(12, o, u)) : 1 !== e.length || i[s].length || !this._lexHas("nn", RiTa.singularize(o)) && this._lexHas("vb", RiTa.singularize(o)) && (u = "vbz",
                this._ct(12, o, u))),
                ("vb" === u || "nn" === u && this.hasTag(i[s], "vb")) && s > 0 && t[s - 1].match(/^(nns|nnps|prp)$/) && (u = "vbp",
                this._ct(13, o, u)),
                t[s] = u
            }
            return t
        },
        _lexHas: function(e, t) {
            for (var t = is(t, A) || [t], i = 0; i < t.length; i++)
                if (RiTa.lexicon.containsWord(t[i])) {
                    if (null == e)
                        return !0;
                    for (var n = RiTa.lexicon._getPosArr(t[i]), r = 0; r < n.length; r++)
                        if ("n" === e && PosTagger.isNoun(n[r]) || "v" === e && PosTagger.isVerb(n[r]) || "r" === e && PosTagger.isAdverb(n[r]) || "a" === e && PosTagger.isAdj(n[r]) || e === n[r])
                            return !0
                }
        }
    };
    RiTa.stemmers.Porter = function() {
        ...
        return function(i) {
            var s, c, h, p, d, g, f, R;
            return i.length < 3 ? i : (p = i.substr(0, 1),
            "y" == p && (i = p + i.substr(1)),
            d = /^(.+?)(ss|i)es$/,
            g = /^(.+?)([^s])s$/,
            d.test(i) ? i = i.replace(d, "$1$2") : g.test(i) && (i = i.replace(g, "$1$2")),
            d = /^(.+?)eed$/,
            g = /^(.+?)(ed|ing)$/,
            d.test(i) ? (s = d.exec(i),
            d = new RegExp(a),
            d.test(s[1]) && (d = /.$/,
            i = i.replace(d, E))) : g.test(i) && (s = g.exec(i),
            c = s[1],
            g = new RegExp(l),
            g.test(c) && (i = c,
            g = /(at|bl|iz)$/,
            f = new RegExp("([^aeiouylsz])\\1$"),
            R = new RegExp("^" + r + n + "[^aeiouwxy]$"),
            g.test(i) ? i += "e" : f.test(i) ? (d = /.$/,
            i = i.replace(d, E)) : R.test(i) && (i += "e"))),
            d = /^(.+?)y$/,
            d.test(i) && (s = d.exec(i),
            c = s[1],
            d = new RegExp(l),
            ...
            c = s[1],
            d = new RegExp(u),
            d.test(c) && (i = c)) : g.test(i) && (s = g.exec(i),
            c = s[1] + s[2],
            g = new RegExp(u),
            g.test(c) && (i = c)),
            d = /^(.+?)e$/,
            ...
            d = new RegExp(u),
            g = new RegExp(o),
            f = new RegExp("^" + r + n + "[^aeiouwxy]$"),
            (d.test(c) || g.test(c) && !f.test(c)) && (i = c)),
            d = /ll$/,
            g = new RegExp(u),
            d.test(i) && g.test(i) && (d = /.$/,
            i = i.replace(d, E)),
    ...
    RiTa.stemmers.Lancaster = function() {
        function e(e) {
            return e.match(/^[aeiou]/) ? e.length > 1 : e.length > 2 && e.match(/[aeiouy]/)
        }
        function t(n, r) {
            var s = n.substr(-1)
              , a = i[s];
            if (a)
                for (var o = 0; o < a.length; o++)
                    if ((r || !a[o].intact) && n.substr(0 - a[o].pattern.length) == a[o].pattern) {
                        var u = n.substr(0, n.length - a[o].size);
                        if (a[o].appendage && (u += a[o].appendage),
                        e(u))
                            return n = u,
                            a[o].continuation ? t(u, !1) : u
                    }
            return n
        }
        var i = {
    ...
    var categorySP = ["acoustics", "aesthetics", "aquatics", "basics", "ceramics", "classics", "cosmetics", "dialectics", "deer", "dynamics", "ethics", "harmonics", "heroics", "mechanics", "metrics", "optics", "people", "physics", "polemics", "pyrotechnics", "quadratics", "quarters", "statistics", "tactics", "tropics"]
      ...
      , categoryUM_A = ["addenda", "agenda", "aquaria", "bacteria", "candelabra", "compendia", "consortia", "crania", "curricula", "data", "desiderata", "dicta", "emporia", "enconia", "errata", "extrema", "gymnasia", "honoraria", "interregna", "lustra", "maxima", "media", "memoranda", "millenia", "minima", "momenta", "optima", "ova", "phyla", "quanta", "rostra", "spectra", "specula", "stadia", "strata", "symposia", "trapezia", "ultimata", "vacua", "vela"]
      , categoryON_A = ["aphelia", "asyndeta", "automata", "criteria", "hyperbata", "noumena", "organa", "perihelia", "phenomena", "prolegomena", "referenda"]
      , categoryO_I = ["alti", "bassi", "canti", "contralti", "crescendi", "libretti", "soli", "soprani", "tempi", "virtuosi"]
      , categoryUS_I = ["alumni", "bacilli", "cacti", "foci", "fungi", "genii", "hippopotami", "incubi", "nimbi", "nuclei", "nucleoli", "octopi", "radii", "stimuli", "styli", "succubi", "syllabi", "termini", "tori", "umbilici", "uteri"]
      , categoryIX_ICES = ["appendices", "cervices"]
      , categoryIS_ES = ["analyses", "axes", "bases", "crises", "diagnoses", "ellipses", "emphases", "neuroses", "oases", "paralyses", "prognoses", "synopses"]
      ...
      , categoryEX_ICES = ["apices", "codices", "cortices", "indices", "latices", "murices", "pontifices", "silices", "simplices", "vertices", "vortices"]
      , categoryU_US = ["menus", "gurus", "apercus", "barbus", "cornus", "ecrus", "emus", "fondus", "gnus", "iglus", "mus", "nandus", "napus", "poilus", "quipus", "snafus", "tabus", "tamandus", "tatus", "timucus", "tiramisus", "tofus", "tutus"]
      , categorySSE_SSES = ["bouillabaisses", "coulisses", "crevasses", "crosses", "cuisses", "demitasses", "ecrevisses", "fesses", "finesses", "fosses", "impasses", "lacrosses", "largesses", "masses", "noblesses", "palliasses", "pelisses", "politesses", "posses", "tasses", "wrasses"]
        ...
        _computeRawArray: function(e, t) {
            ...
            o = e.length; s <= o; s++)
                ...
                u = t.length; a <= u; a++)
                    n = t[a - 1],
                    r = i === n ? 0 : 1,
                    l[s][a] = this._min3(l[s - 1][a] + 1, l[s][a - 1] + 1, l[s - 1][a - 1] + r);
            return l[e.length][t.length]
        },
        computeRaw: function(e, t) {
            if (is(e, A))
                return this._computeRawArray(e, t);
            if (!e.length && !t.length)
                return 0;
            var i, n, r, s, a, o = [], u = e.length, l = t.length;
            if (!u)
                return l;
            if (!l)
                return u;
            ...
            for (i = 1; i <= u; i++)
                ...
                n = 1; n <= l; n++)
                    a = t.charAt(n - 1),
                    r = s == a ? 0 : 1,
                    o[i][n] = this._min3(o[i - 1][n] + 1, o[i][n - 1] + 1, o[i - 1][n - 1] + r);
            return o[u][l]
        },
        computeAdjusted: function(e, t) {
            var i = get(e)
              , n = get(e);
            if (i === n) {
                if (n === S)
                    return e.length || t.length ? this.computeRaw(e, t) / Math.max(e.length, t.length) : 0;
                if (n === A)
                    return e.length || t.length ? this._computeRawArray(e, t) / Math.max(e.length, t.length) : 0
            }
            err("Unexpected args: " + e + "/" + t)
        }
    }
      , Concorder = makeClass();
    Concorder.prototype = {
        init: function(e, t) {
            ...
            this.wordsToIgnore = [],
            this.ignoreCase = !1,
            this.ignoreStopWords = !1,
            this.ignorePunctuation = !1,
            t && (t.ignoreCase && (this.ignoreCase = !0),
            t.ignoreStopWords && (this.ignoreStopWords = !0),
            t.ignorePunctuation && (this.ignorePunctuation = !0),
            t.wordsToIgnore && (this.wordsToIgnore = t.wordsToIgnore)),
            this.ignoreStopWords && (this.wordsToIgnore = this.wordsToIgnore.concat(RiTa.STOP_WORDS)),
            this.words = is(e, A) ? e : RiTa.tokenize(e)
        },
        count: function(e) {
            var t = this.lookup(e);
        ...
        concordance: function() {
            ...
            var e = {};
            for (var t in this.model)
                e[t] = this.model[t].indexes.length;
            return e
        },
        kwic: function(e, t) {
            var i = this.lookup(e)
              , n = [];
            if (i)
                for (var r = i.indexes, s = 0; s < r.length; s++) {
                    var a = this.words.slice(Math.max(0, r[s] - t), Math.min(this.words.length, r[s] + t + 1));
                    (s < 1 || r[s] - r[s - 1] > t) && n.push(RiTa.untokenize(a))
                }
            return n
        },
        build: function() {
            ...
            this.model = {};
            for (var e = (+new Date,
            0); e < this.words.length; e++) {
                var t = this.words[e];
                if (!this.ignorable(t)) {
                    var i = this.lookup(t);
                    i && "object" == typeof i || (i = {
                        word: t,
                        key: this.compareKey(t),
                        indexes: []
                    },
                    this.model[i.key] = i),
                    i.indexes.push(e)
        ...
        ignorable: function(e) {
            if (this.ignorePunctuation && RiTa.isPunctuation(e))
                return !0;
            for (var t = 0; t < this.wordsToIgnore.length; t++) {
                var i = this.wordsToIgnore[t];
                if (this.ignoreCase && e.toUpperCase() === i.toUpperCase() || e === i)
                    return !0
            }
            return !1
        },
        compareKey: function(e) {
            return this.ignoreCase ? e.toLowerCase() : e
        },
        lookup: function(e) {
            var t = this.compareKey(e);
            return this.model || this.build(),
            this.model[t]
        }
    };
    var RE = makeClass();
    ...
    RiTa.SILENT || isNode() || !console || console.log("[INFO] RiTaJS.version [" + RiTa.VERSION + "]"),
    RiTa.lexicon = RiLexicon();
    for (var funs = okeys(RiTa.lexicon), i = 0; i < funs.length; i++)
    ...
    if (window) {
        ...
        for (var funs = okeys(RiTa), i = 0; i < funs.length; i++)
            startsWith(funs[i], "_") || (module.exports[funs[i]] = RiTa[funs[i]])
    }
